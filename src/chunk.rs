...
pub const OP_EQUAL: OpCode = 14;
pub const OP_GREATER: OpCode = 15;
pub const OP_LESS: OpCode = 16;
pub const OP_ADD: OpCode = 17;
pub const OP_SUBTRACT: OpCode = 18;
pub const OP_MULTIPLY: OpCode = 19;
pub const OP_DIVIDE: OpCode = 20;
pub const OP_NOT: OpCode = 21;
pub const OP_NEGATE: OpCode = 22;
pub const OP_PRINT: OpCode = 23;
pub const OP_JUMP: OpCode = 24;
